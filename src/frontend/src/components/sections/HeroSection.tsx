  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center pt-16 md:pt-20">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        {/* Gradient overlay for text readability with warm tones */}
        ...
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a
              ...
              className="group inline-flex items-center justify-center gap-3 px-10 py-5 bg-white text-primary rounded-2xl font-bold text-lg hover:bg-white/95 transition-all shadow-2xl hover:shadow-[0_20px_50px_rgba(0,0,0,0.3)] hover:scale-105 min-h-[64px] border-2 border-white/20"
            >
